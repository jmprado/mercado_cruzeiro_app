...
public static class SeedData
{
    ...
    {
        new Produto { Id = 1, Nome = "Arroz", Preco = 10 },
        new Produto { Id = 2, Nome = "Feijão", Preco = 5 },
        new Produto { Id = 3, Nome = "Macarrão", Preco = 3 },
        new Produto { Id = 4, Nome = "Óleo", Preco = 7 },
        new Produto { Id = 5, Nome = "Sal", Preco = 2 },
        new Produto { Id = 6, Nome = "Açúcar", Preco = 4 },
        new Produto { Id = 7, Nome = "Café", Preco = 8 },
        new Produto { Id = 8, Nome = "Leite", Preco = 6 },
        new Produto { Id = 9, Nome = "Manteiga", Preco = 9 },
        new Produto { Id = 10, Nome = "Queijo", Preco = 12 },
        new Produto { Id = 11, Nome = "Presunto", Preco = 15 },
        new Produto { Id = 12, Nome = "Pão", Preco = 1 },
        new Produto { Id = 13, Nome = "Bolo", Preco = 20 },
        new Produto { Id = 14, Nome = "Refrigerante", Preco = 5 },
        new Produto { Id = 15, Nome = "Cerveja", Preco = 3 },
        new Produto { Id = 16, Nome = "Vinho", Preco = 10 },
        new Produto { Id = 17, Nome = "Whisky", Preco = 50 },
        new Produto { Id = 18, Nome = "Vodka", Preco = 30 },
        new Produto { Id = 19, Nome = "Tequila", Preco = 25 },
        new Produto { Id = 20, Nome = "Cachaça", Preco = 20 },
        new Produto { Id = 21, Nome = "Licor", Preco = 15 },
        new Produto { Id = 22, Nome = "Suco", Preco = 5 },
        new Produto { Id = 23, Nome = "Água", Preco = 2 },
        new Produto { Id = 24, Nome = "Energético", Preco = 10 },
        new Produto { Id = 25, Nome = "Café", Preco = 8 },
        new Produto { Id = 26, Nome = "Chá", Preco = 5 },
        new Produto { Id = 27, Nome = "Chocolate", Preco = 3 },
        new Produto { Id = 28, Nome = "Balas", Preco = 1 },
        new Produto { Id = 29, Nome = "Salgadinhos", Preco = 6 },
    };
